...
fraudeRouter.get("/fraudes/smss/readonly/:id", authRoutes, smssReadonlyPage);
...
fraudeRouter.get("/fraudes/hitoseventos/readonly/:id", authRoutes, hitoseventosReadonlyPage);
