...
const getCookie=l=>{let t="";return document.cookie.split(";").forEach(e=>{e.includes(l)&&(t=e.split("=")[1])}),t},setCookie=(e,l,t)=>{let i="";var n;t&&((n=new Date).setTime(n.getTime()+24*t*60*60*1e3),i="; expires="+n.toUTCString()),document.cookie=e+"="+(l||"")+i+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(i=>{i.addEventListener("click",()=>{var e=i.parentElement.parentElement.parentElement,l=Array.prototype.indexOf.call(i.parentElement.children,i),t=i.classList.contains("th-sort-asc");sortTableByColumn(e,l,!t)})}),(e,t,l=!0)=>{const i=l?1:-1;var n,s=e.tBodies[0];for(n of Array.from(s.querySelectorAll("tr")).sort((e,l)=>{e=e.cells[t].textContent;return l.cells[t].textContent<e?i:-1*i}))s.appendChild(n);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-asc",l),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-desc",!l)}),buildTable=e=>{const i=document.getElementById("table-body");i.innerHTML="",e.map(e=>{var l=document.createElement("tr");let t=document.createElement("td");t.classList.add("w-4"),e.STAFRA===estados.pendiente?t.innerHTML=`<div class="align-items-center py-1">
      ...
      <div class="flex-fill">
        ...
        <li class="nav-item drop-right">
          ...
          <ul>
            <li class="nav-item">
              <a href="/admin/fraudes/readonly/${e.IDFRAU}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke-width=".4" fill="none" d="M6.85 20.575q-.6 0-1.012-.412-.413-.413-.413-1.013V4.85q0-.6.413-1.013.412-.412 1.012-.412h7.825L18.6 7.35v3.4h-.65V7.675h-3.6V4.05h-7.5q-.3 0-.55.25-.25.25-.25.55v14.275q0 .3.25.55.25.25.55.25h4.25v.65Zm-.8-.65V4.05 19.925ZM17.025 14.6l.45.425-3.75 3.75v1.1h1.1l3.775-3.75.45.45-3.95 3.95h-2v-2Zm2.025 1.975L17.025 14.6l1.05-1.05q.225-.2.525-.2.3 0 .475.2l1 1q.2.2.2.487 0 .288-.2.538Z"/></svg>
                </svg>
                Fraude
      ...
      </ul>`,l.appendChild(t),i.appendChild(l)}),createPages()},createPages=()=>{let e="<ul>";hasPrevs?e+="<li class='page-item previous no'><a href='/admin/fraudes?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFraudeBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNexts?e+="<li class='page-item next no'><a href='/admin/fraudes?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFraudeBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e},elemBuscar=document.getElementById("buscarFraudeBox"),elemDel=(elemBuscar.onchange=e=>{setCookie("filtro",e.target.value,.5)},elemBuscar.value=getCookie("filtro"),document.getElementById("del")),elemAdes=(elemDel.setAttribute("action","/admin/fraudes/delete?part="+getCookie("filtro")),document.getElementById("ades")),elemDesag=(elemAdes.setAttribute("href","/admin/fraudes/ades?part="),document.getElementById("desag")),elemRes=(elemDesag.setAttribute("action","/admin/fraudes/desasignar?part="+getCookie("filtro")),document.getElementById("rsltos"));elemRes.setAttribute("href","/admin/fraudes/resueltos?part="+getCookie("filtro")),buildTable(orgList);