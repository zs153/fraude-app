...
const getCookie=i=>{let t="";return document.cookie.split(";").forEach(e=>{e.includes(i)&&(t=e.split("=")[1])}),t},setCookie=(e,i,t)=>{let l="";var n;t&&((n=new Date).setTime(n.getTime()+24*t*60*60*1e3),l="; expires="+n.toUTCString()),document.cookie=e+"="+(i||"")+l+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(l=>{l.addEventListener("click",()=>{var e=l.parentElement.parentElement.parentElement,i=Array.prototype.indexOf.call(l.parentElement.children,l),t=l.classList.contains("th-sort-asc");sortTableByColumn(e,i,!t)})}),(e,t,i=!0)=>{const l=i?1:-1;var n,s=e.tBodies[0];for(n of Array.from(s.querySelectorAll("tr")).sort((e,i)=>{e=e.cells[t].textContent;return i.cells[t].textContent<e?l:-1*l}))s.appendChild(n);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-asc",i),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-desc",!i)}),buildTable=e=>{const l=document.getElementById("table-body");l.innerHTML="",e.map(e=>{var i=document.createElement("tr");let t=document.createElement("td");t.classList.add("w-4"),e.STAFRA===estados.pendiente?t.innerHTML=`<div class="align-items-center py-1">
    ...
    </div>`,i.appendChild(t),(t=document.createElement("td")).classList.add("w-10"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${30<e.DESTIP.length?e.DESTIP.slice(0,30)+"...":e.DESTIP}</div>
      </div>
    </div>`,i.appendChild(t),t=document.createElement("td"),null!==e.OBSFRA&&(t.innerHTML=`<div class="d-flex py-1 align-items-center">
        <div class="flex-fill">
          <div class="font-weight-medium">${37<e.OBSFRA.length?e.OBSFRA.slice(0,37)+"...":e.OBSFRA}</div>
        </div>
      </div>`),i.appendChild(t),(t=document.createElement("td")).classList.add("w-5"),e.STAFRA===estados.pendiente?t.innerHTML=`<ul class="dots-menu">
