/*! fraudes 2023-06-03 */
const getCookie=i=>{let l="";return document.cookie.split(";").forEach(e=>{e.includes(i)&&(l=e.split("=")[1])}),l},setCookie=(e,i,l)=>{let n="";var t;l&&((t=new Date).setTime(t.getTime()+24*l*60*60*1e3),n="; expires="+t.toUTCString()),document.cookie=e+"="+(i||"")+n+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(n=>{n.addEventListener("click",()=>{var e=n.parentElement.parentElement.parentElement,i=Array.prototype.indexOf.call(n.parentElement.children,n),l=n.classList.contains("th-sort-asc");sortTableByColumn(e,i,!l)})}),(e,l,i=!0)=>{const n=i?1:-1;var t,s=e.tBodies[0];for(t of Array.from(s.querySelectorAll("tr")).sort((e,i)=>{e=e.cells[l].textContent;return i.cells[l].textContent<e?n:-1*n}))s.appendChild(t);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-asc",i),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-desc",!i)}),buildTable=e=>{const n=document.getElementById("table-body");n.innerHTML="",e.map(e=>{var i=document.createElement("tr");let l=document.createElement("td");l.classList.add("w-4"),e.STAFRA===estadosFraude.pendiente?l.innerHTML=`<div class="align-items-center py-1">
        <span class="avatar avatar-rounded bg-red-lt">
          <h6>${e.LIQFRA}</h6>
        </span>
      </div>`:e.STAFRA===estadosFraude.asignado?0===e.NUMHIT&&0===e.NUMEVE?l.innerHTML=`<div class="align-items-center py-1">
          <span class="avatar avatar-rounded bg-blue-lt">
            <h6>${e.LIQFRA}</h6>
          </span>
        </div>`:l.innerHTML=`<ul class="dots-menu">
          <li class="nav-item drop-left p-0">
            ...
            <ul class='ms-4'>
              <li>
                <h4 class='m-0'>Hitos: ${0<e.NUMHIT?"Sí":"No"}</h4>
              </li>
              <li>
                <h4 class='m-0'>Eventos: ${0<e.NUMEVE?"Sí":"No"}</h4>
              </li>
            </ul>
          </li>
        </ul>`:e.STAFRA===estadosFraude.resuelto&&(l.innerHTML=`<div class="align-items-center py-1">
    ...
    </div>`,i.appendChild(l),(l=document.createElement("td")).innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.NOMCON}</div>
      </div>
    </div>`,i.appendChild(l),(l=document.createElement("td")).classList.add("w-10"),l.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${30<e.DESTIP.length?e.DESTIP.slice(0,30)+"...":e.DESTIP}</div>
      </div>
    </div>`,i.appendChild(l),l=document.createElement("td"),null!==e.OBSFRA&&(l.innerHTML=`<div class="d-flex py-1 align-items-center">
        <div class="flex-fill">
          <div class="font-weight-medium">${30<e.OBSFRA.length?e.OBSFRA.slice(0,30)+"...":e.OBSFRA}</div>
        </div>
      </div>`),i.appendChild(l),(l=document.createElement("td")).classList.add("w-5"),e.STAFRA===estadosFraude.pendiente?l.innerHTML=`<ul class="dots-menu">
      ...
      </ul>`:e.STAFRA===estadosFraude.resuelto?l.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          <a href="#" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke-width="1" fill="none" d="M12 18.7q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687.288-.288.688-.288.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.688.288-.287.688-.287.4 0 .688.287.287.288.287.688 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687Q11.6 5.3 12 5.3q.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Z"/>
