...
const getCookie=l=>{let t="";return document.cookie.split(";").forEach(e=>{e.includes(l)&&(t=e.split("=")[1])}),t},setCookie=(e,l,t)=>{let i="";var s;t&&((s=new Date).setTime(s.getTime()+24*t*60*60*1e3),i="; expires="+s.toUTCString()),document.cookie=e+"="+(l||"")+i+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(i=>{i.addEventListener("click",()=>{var e=i.parentElement.parentElement.parentElement,l=Array.prototype.indexOf.call(i.parentElement.children,i),t=i.classList.contains("th-sort-asc");sortTableByColumn(e,l,!t)})}),(e,t,l=!0)=>{const i=l?1:-1;var s,n=e.tBodies[0];for(s of Array.from(n.querySelectorAll("tr")).sort((e,l)=>{e=e.cells[t].textContent;return l.cells[t].textContent<e?i:-1*i}))n.appendChild(s);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-asc",l),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-desc",!l)}),buildTable=e=>{const i=document.getElementById("table-body");i.innerHTML="",e.map(e=>{var l=document.createElement("tr");let t=document.createElement("td");t.classList.add("w-4"),e.STAFRA===estadosFraude.pendiente?t.innerHTML=`<div class="align-items-center py-1">
        ...
        </ul>`:e.STAFRA===estadosFraude.resuelto&&(t.innerHTML=`<div class="align-items-center py-1">
    ...
    </div>`,l.appendChild(t),(t=document.createElement("td")).innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.NOMCON}</div>
      </div>
    </div>`,l.appendChild(t),(t=document.createElement("td")).classList.add("w-10"),t.innerHTML=`<div class="d-flex py-1 align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${30<e.DESTIP.length?e.DESTIP.slice(0,30)+"...":e.DESTIP}</div>
      </div>
    </div>`,l.appendChild(t),t=document.createElement("td"),null!==e.OBSFRA&&(t.innerHTML=`<div class="d-flex py-1 align-items-center">
        <div class="flex-fill">
          <div class="font-weight-medium">${30<e.OBSFRA.length?e.OBSFRA.slice(0,30)+"...":e.OBSFRA}</div>
        </div>
      </div>`),l.appendChild(t),(t=document.createElement("td")).classList.add("w-5"),e.STAFRA===estadosFraude.pendiente?t.innerHTML=`<ul class="dots-menu">
      ...
      </ul>`:e.STAFRA===estadosFraude.resuelto?t.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          <a href="#" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke-width="1" fill="none" d="M12 18.7q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687.288-.288.688-.288.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.688.288-.287.688-.287.4 0 .688.287.287.288.287.688 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687Q11.6 5.3 12 5.3q.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Z"/>
