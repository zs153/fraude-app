...
const getCookie=i=>{let l="";return document.cookie.split(";").forEach(e=>{e.includes(i)&&(l=e.split("=")[1])}),l},setCookie=(e,i,l)=>{let t="";var s;l&&((s=new Date).setTime(s.getTime()+24*l*60*60*1e3),t="; expires="+s.toUTCString()),document.cookie=e+"="+(i||"")+t+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(t=>{t.addEventListener("click",()=>{var e=t.parentElement.parentElement.parentElement,i=Array.prototype.indexOf.call(t.parentElement.children,t),l=t.classList.contains("th-sort-asc");sortTableByColumn(e,i,!l)})}),(e,l,i=!0)=>{const t=i?1:-1;var s,n=e.tBodies[0];for(s of Array.from(n.querySelectorAll("tr")).sort((e,i)=>{e=e.cells[l].textContent;return i.cells[l].textContent<e?t:-1*t}))n.appendChild(s);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-asc",i),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-desc",!i)}),buildTable=e=>{const t=document.getElementById("table-body");t.innerHTML="",e.map(e=>{var i=document.createElement("tr");let l=document.createElement("td");l.classList.add("w-4"),e.STAFRA===estadosFraude.pendiente?l.innerHTML=`<div class="align-items-center py-1">
      ...
      <div class="flex-fill">
        ...
        <li class="nav-item drop-right">
          ...
          <ul>
            ...
            <li class="nav-item">
              <a href="/user/fraudes/ejercicios/add/${e.IDFRAU}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      </ul>`,i.appendChild(l),t.appendChild(i)}),createPages()},createPages=()=>{let e="<ul>";hasPrevFras?e+="<li class='page-item previous no'><a href='/user/fraudes?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFraudeBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNextFras?e+="<li class='page-item next no'><a href='/user/fraudes?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFraudeBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e},elemBuscar=document.getElementById("buscarFraudeBox"),elemNew=(elemBuscar.onchange=e=>{setCookie("filtro",e.target.value,.5)},elemBuscar.value=getCookie("filtro"),document.getElementById("new")),elemDel=(elemNew.setAttribute("href","/user/fraudes/add?part="+getCookie("filtro")),document.getElementById("del")),elemDesag=(elemDel.setAttribute("action","/user/fraudes/delete?part="+getCookie("filtro")),document.getElementById("desag")),elemAsig=(elemDesag.setAttribute("action","/user/fraudes/desasignar?part="+getCookie("filtro")),document.getElementById("asig")),elemRes=(elemAsig.setAttribute("action","/user/fraudes/asignar?part="+getCookie("filtro")),document.getElementById("res"));elemRes.setAttribute("href","/user/fraudes/resueltos?part="+getCookie("filtro")),buildTable(orgList);