/*! fraudes 2023-05-24 */
const getCookie=l=>{let i="";return document.cookie.split(";").forEach(e=>{e.includes(l)&&(i=e.split("=")[1])}),i},setCookie=(e,l,i)=>{let n="";var s;i&&((s=new Date).setTime(s.getTime()+24*i*60*60*1e3),n="; expires="+s.toUTCString()),document.cookie=e+"="+(l||"")+n+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(n=>{n.addEventListener("click",()=>{var e=n.parentElement.parentElement.parentElement,l=Array.prototype.indexOf.call(n.parentElement.children,n),i=n.classList.contains("th-sort-asc");sortTableByColumn(e,l,!i)})}),(e,i,l=!0)=>{const n=l?1:-1;var s,t=e.tBodies[0];for(s of Array.from(t.querySelectorAll("tr")).sort((e,l)=>{e=e.cells[i].textContent;return l.cells[i].textContent<e?n:-1*n}))t.appendChild(s);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${i+1})`).classList.toggle("th-sort-asc",l),e.querySelector(`th:nth-child(${i+1})`).classList.toggle("th-sort-desc",!l)}),buildTable=e=>{const n=document.getElementById("table-body");n.innerHTML="",e.map(e=>{var l=document.createElement("tr");let i=document.createElement("td");i.classList.add("w-4"),e.STAFRA===estadosFraude.pendiente?i.innerHTML=`<div class="align-items-center py-1">
