...
const getCookie=l=>{let t="";return document.cookie.split(";").forEach(e=>{e.includes(l)&&(t=e.split("=")[1])}),t},setCookie=(e,l,t)=>{let i="";var s;t&&((s=new Date).setTime(s.getTime()+24*t*60*60*1e3),i="; expires="+s.toUTCString()),document.cookie=e+"="+(l||"")+i+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(i=>{i.addEventListener("click",()=>{var e=i.parentElement.parentElement.parentElement,l=Array.prototype.indexOf.call(i.parentElement.children,i),t=i.classList.contains("th-sort-asc");sortTableByColumn(e,l,!t)})}),(e,t,l=!0)=>{const i=l?1:-1;var s,n=e.tBodies[0];for(s of Array.from(n.querySelectorAll("tr")).sort((e,l)=>{e=e.cells[t].textContent;return l.cells[t].textContent<e?i:-1*i}))n.appendChild(s);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-asc",l),e.querySelector(`th:nth-child(${t+1})`).classList.toggle("th-sort-desc",!l)}),buildTable=e=>{const i=document.getElementById("table-body");i.innerHTML="",e.map(e=>{var l=document.createElement("tr");let t=document.createElement("td");t.classList.add("w-4"),e.STAFRA===estados.pendiente?t.innerHTML=`<div class="align-items-center py-1">
        ...
        </ul>`:e.STAFRA===estados.resuelto&&(t.innerHTML=`<div class="align-items-center py-1">
      ...
      <div class="flex-fill">
        ...
        <div class="flex-fill">
          <div class="font-weight-medium">${37<e.OBSFRA.length?e.OBSFRA.slice(0,37)+"...":e.OBSFRA}</div>
        </div>
      </div>`),l.appendChild(t),(t=document.createElement("td")).classList.add("w-5"),e.STAFRA===estados.pendiente?t.innerHTML=`<ul class="dots-menu">
      ...
      </ul>`:e.STAFRA===estados.resuelto?t.innerHTML=`<ul class="dots-menu">
        <li class="nav-item drop-right">
          <a href="#" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke-width="1" fill="none" d="M12 18.7q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687.288-.288.688-.288.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.688.288-.287.688-.287.4 0 .688.287.287.288.287.688 0 .4-.287.688-.288.287-.688.287Zm0-5.725q-.4 0-.688-.287-.287-.288-.287-.688 0-.4.287-.687Q11.6 5.3 12 5.3q.4 0 .688.288.287.287.287.687 0 .4-.287.688-.288.287-.688.287Z"/>
          ...
          <ul>
            <li class="nav-item">
              <a href="/user/fraudes/readonly/${e.IDFRAU}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke-width=".4" fill="none" d="M6.85 20.575q-.6 0-1.012-.412-.413-.413-.413-1.013V4.85q0-.6.413-1.013.412-.412 1.012-.412h7.825L18.6 7.35v3.4h-.65V7.675h-3.6V4.05h-7.5q-.3 0-.55.25-.25.25-.25.55v14.275q0 .3.25.55.25.25.55.25h4.25v.65Zm-.8-.65V4.05 19.925ZM17.025 14.6l.45.425-3.75 3.75v1.1h1.1l3.775-3.75.45.45-3.95 3.95h-2v-2Zm2.025 1.975L17.025 14.6l1.05-1.05q.225-.2.525-.2.3 0 .475.2l1 1q.2.2.2.487 0 .288-.2.538Z"/></svg>
                </svg>
                Fraude
      ...
      </ul>`,l.appendChild(t),i.appendChild(l)}),createPages()},createPages=()=>{let e="<ul>";hasPrevs?e+="<li class='page-item previous no'><a href='/user/fraudes?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFraudeBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNexts?e+="<li class='page-item next no'><a href='/user/fraudes?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFraudeBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e},elemBuscar=document.getElementById("buscarFraudeBox"),elemNew=(elemBuscar.onchange=e=>{setCookie("filtro",e.target.value,.5)},elemBuscar.value=getCookie("filtro"),document.getElementById("new")),elemDel=(elemNew.setAttribute("href","/user/fraudes/add?part="+getCookie("filtro")),document.getElementById("del")),elemDesag=(elemDel.setAttribute("action","/user/fraudes/delete?part="+getCookie("filtro")),document.getElementById("desag")),elemAsig=(elemDesag.setAttribute("action","/user/fraudes/desasignar?part="+getCookie("filtro")),document.getElementById("asig")),elemCerr=(elemAsig.setAttribute("action","/user/fraudes/asignar?part="+getCookie("filtro")),document.getElementById("cerr")),elemRes=(elemCerr.setAttribute("action","/user/fraudes/resolver?part="+getCookie("filtro")),document.getElementById("rsltos"));elemRes.setAttribute("href","/user/fraudes/resueltos?part="+getCookie("filtro")),buildTable(orgList);