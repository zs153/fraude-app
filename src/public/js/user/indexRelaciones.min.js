...
const getCookie=t=>{let l="";return document.cookie.split(";").forEach(e=>{e.includes(t)&&(l=e.split("=")[1])}),l},setCookie=(e,t,l)=>{let i="";var n;l&&((n=new Date).setTime(n.getTime()+24*l*60*60*1e3),i="; expires="+n.toUTCString()),document.cookie=e+"="+(t||"")+i+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(i=>{i.addEventListener("click",()=>{var e=i.parentElement.parentElement.parentElement,t=Array.prototype.indexOf.call(i.parentElement.children,i),l=i.classList.contains("th-sort-asc");sortTableByColumn(e,t,!l)})}),(e,l,t=!0)=>{const i=t?1:-1;var n,s=e.tBodies[0];for(n of Array.from(s.querySelectorAll("tr")).sort((e,t)=>{e=e.cells[l].textContent;return t.cells[l].textContent<e?i:-1*i}))s.appendChild(n);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-asc",t),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-desc",!t)}),buildTable=e=>{const i=document.getElementById("table-body");i.innerHTML="",e.map(e=>{var t=document.createElement("tr");let l=document.createElement("td");l.classList.add("w-3"),l.innerHTML=`<div class="align-items-center py-1">
      ...
      <div class="flex-fill">
        <div class="font-weight-medium">${e.FECREL.slice(0,10).split("-").reverse().join("/")}</div>
      </div>
      ...
      <li class="nav-item drop-right">
        ...
        <ul>
          <li class="nav-item">
            <a href="/user/fraudes/relaciones/edit/${e.IDFRAU}/${e.IDRELA}" class="nav-link">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    </ul>`,t.appendChild(l),i.appendChild(t)}),createPages()},createPages=()=>{let e="<ul>";hasPrevs?e+="<li class='page-item previous no'><a href='/user/fraudes/relaciones?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarRelBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNexts?e+="<li class='page-item next no'><a href='/user/fraudes/relaciones?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarRelBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e},elemBuscar=document.getElementById("buscarRelBox"),elemNew=(elemBuscar.onchange=e=>{setCookie("filtra",e.target.value,.5)},elemBuscar.value=getCookie("filtra"),document.getElementById("new")),elemDel=(elemNew.setAttribute("href",`/user/fraudes/relaciones/add/${fraude.IDFRAU}?part=`+getCookie("filtro")),document.getElementById("del")),elemVol=(elemDel.setAttribute("action","/user/fraudes/relaciones/delete?part="+getCookie("filtro")),document.getElementById("vol"));elemVol.setAttribute("href","/user/fraudes/?part="+getCookie("filtro")),buildTable(orgList);