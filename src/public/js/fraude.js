      ...
      cell.innerHTML = `<ul class="dots-menu">
        <li class="nav-item drop-right">
          ...
          <ul>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('idasig').value ='${element.IDFRAU}', document.getElementById('msgasi').innerHTML ='<p>${element.REFFRA}</p><p>${element.NIFCON}</p><p>${element.NOMCON}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-asignar">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('idborr').value ='${element.IDFRAU}', document.getElementById('msgbor').innerHTML ='<p>${element.REFFRA}</p><p>${element.NIFCON}</p><p>${element.NOMCON}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-borrar">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <ul>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('deshacer').value ='${element.IDFRAU}', document.getElementById('texcie').innerHTML ='<p>${element.REFFRA}</p><p>${element.NIFCON}</p><p>${element.NOMCON}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-deshacer">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke-width=".4" fill="none" d="M7.6 18.25v-.625h6.35q1.85 0 3.2-1.175t1.35-2.975q0-1.775-1.35-2.963-1.35-1.187-3.2-1.187H6.1l3.25 3.25-.45.45L4.875 9 8.9 4.975l.45.475L6.1 8.7h7.85q2.1 0 3.65 1.362 1.55 1.363 1.55 3.413t-1.55 3.412q-1.55 1.363-3.65 1.363Z"/>
                </svg>
                Deshacer cierre
              </a>
            </li>
      ...
      cell.innerHTML = `<ul class="dots-menu">
        <li class="nav-item drop-right">
          ...
          <ul>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('iddesa').value ='${element.IDFRAU}', document.getElementById('msgdes').innerHTML ='<p>${element.REFFRA}</p><p>${element.NIFCON}</p><p>${element.NOMCON}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-desasignar">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
