...
const getCookie=t=>{let l="";return document.cookie.split(";").forEach(e=>{e.includes(t)&&(l=e.split("=")[1])}),l},setCookie=(e,t,l)=>{let i="";var n;l&&((n=new Date).setTime(n.getTime()+24*l*60*60*1e3),i="; expires="+n.toUTCString()),document.cookie=e+"="+(t||"")+i+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(i=>{i.addEventListener("click",()=>{var e=i.parentElement.parentElement.parentElement,t=Array.prototype.indexOf.call(i.parentElement.children,i),l=i.classList.contains("th-sort-asc");sortTableByColumn(e,t,!l)})}),(e,l,t=!0)=>{const i=t?1:-1;var n,a=e.tBodies[0];for(n of Array.from(a.querySelectorAll("tr")).sort((e,t)=>{e=e.cells[l].textContent;return t.cells[l].textContent<e?i:-1*i}))a.appendChild(n);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-asc",t),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-desc",!t)}),buildTable=e=>{const i=document.getElementById("table-body");i.innerHTML="",e.map(e=>{var t=document.createElement("tr");let l=document.createElement("td");l.classList.add("w-4"),l.innerHTML=`<div class="align-items-center">
      ...
      <li class="nav-item drop-right p-0">
        ...
        <ul>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" onclick="{document.getElementById('idusua').value ='${e.IDUSUA}', document.getElementById('msgact').innerHTML ='<p>${e.NOMUSU}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-activar">
    ...
    </ul>`,t.appendChild(l),i.appendChild(t)}),createPages()},createPages=()=>{let e="<ul>";hasPrevUsers?e+="<li class='page-item previous no'><a href='/admin/historicos?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarUserBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNextUsers?e+="<li class='page-item next no'><a href='/admin/historicos?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarUserBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e},elemBuscar=document.getElementById("buscarUserBox"),elemActivar=(elemBuscar.onchange=e=>{setCookie("filtro",e.target.value,.5)},elemBuscar.value=getCookie("filtro"),document.getElementById("activ"));elemActivar.setAttribute("action","/admin/historicos/activar?part="+getCookie("filtro")),buildTable(orgList);