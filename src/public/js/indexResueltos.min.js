...
</div>`),t.appendChild(l),(l=document.createElement("td")).classList.add("w-5"),e.STAFRA===estadosFraude.resuelto&&(l.innerHTML=`<ul class="dots-menu">
