...
const getCookie=i=>{let l="";return document.cookie.split(";").forEach(e=>{e.includes(i)&&(l=e.split("=")[1])}),l},setCookie=(e,i,l)=>{let n="";var s;l&&((s=new Date).setTime(s.getTime()+24*l*60*60*1e3),n="; expires="+s.toUTCString()),document.cookie=e+"="+(i||"")+n+"; path=/"},deleteCookie=()=>{document.cookie="filtro=; expires=Thu, 01 Jan 1970 00:00:01 GMT; Path=/;"},sortTableByColumn=(document.querySelectorAll(".sortable th").forEach(n=>{n.addEventListener("click",()=>{var e=n.parentElement.parentElement.parentElement,i=Array.prototype.indexOf.call(n.parentElement.children,n),l=n.classList.contains("th-sort-asc");sortTableByColumn(e,i,!l)})}),(e,l,i=!0)=>{const n=i?1:-1;var s,t=e.tBodies[0];for(s of Array.from(t.querySelectorAll("tr")).sort((e,i)=>{e=e.cells[l].textContent;return i.cells[l].textContent<e?n:-1*n}))t.appendChild(s);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-asc",i),e.querySelector(`th:nth-child(${l+1})`).classList.toggle("th-sort-desc",!i)}),buildTable=e=>{const n=document.getElementById("table-body");n.innerHTML="",e.map(e=>{var i=document.createElement("tr");let l=document.createElement("td");l.classList.add("w-4"),e.STAFRA===estadosFraude.pendiente?l.innerHTML=`<div class="align-items-center py-1">
      ...
      <div class="flex-fill">
        ...
        <li class="nav-item drop-right">
          ...
          <ul>
            ...
            <li class="nav-item">
              <a href="/admin/fraudes/ejercicio/${e.IDFRAU}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
      ...
      </ul>`,i.appendChild(l),n.appendChild(i)}),createPages()},createPages=()=>{let e="<ul>";hasPrevFras?e+="<li class='page-item previous no'><a href='/user/fraudes/resueltos?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFraudeBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNextFras?e+="<li class='page-item next no'><a href='/user/fraudes/resueltos?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarFraudeBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e},elemBuscar=document.getElementById("buscarFraudeBox"),elemPen=(elemBuscar.onchange=e=>{setCookie("filtro",e.target.value,.5)},elemBuscar.value=getCookie("filtro"),document.getElementById("pen"));elemPen.setAttribute("href","/user/fraudes?part="+getCookie("filtro")),buildTable(orgList);