...
const baseQuery = "SELECT * FROM tiposcierre";
const insertSql = "BEGIN FRAUDE_PKG.INSERTTIPOCIERRE(:destip,:usumov,:tipmov,:idtipo); END;";
const updateSql = "BEGIN FRAUDE_PKG.UPDATETIPOCIERRE(:idtipo,:destip,:usumov,:tipmov); END;";
const removeSql = "BEGIN FRAUDE_PKG.DELETETIPOCIERRE(:idtipo,:usumov,:tipmov ); END;";
