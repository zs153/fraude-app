...
export const mainPage = async (req, res) => {
  ...
  try {
    const result = await axios.post(`http://${serverAPI}:8100/api/usuarios`, {
      usuario,
    })
    const datos = {
...
export const insert = async (req, res) => {
  ...
  try {
    await axios.post(`http://${serverAPI}:8100/api/usuarios/insert`, {
      usuario,
      movimiento,
    })
...
export const update = async (req, res) => {
  ...
  try {
    await axios.post(`http://${serverAPI}:8100/api/usuarios/update`, {
      usuario,
      movimiento,
    })
...
export const remove = async (req, res) => {
  ...
  try {
    await axios.post(`http://${serverAPI}:8100/api/usuarios/delete`, {
      usuario,
      movimiento,
    })
