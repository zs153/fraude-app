  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      js: {
        ...
        //   // controllers
        //   'dist/controllers/admin/admin.controller.js':['./dist/controllers/admin/admin.controller.js'],
        ...
        // }
        src: ['./src/views/admin/fraudes/indexResueltos.js'],
        dest: './src/public/js/indexResueltosAdm.min.js'
      },
    },
  });
